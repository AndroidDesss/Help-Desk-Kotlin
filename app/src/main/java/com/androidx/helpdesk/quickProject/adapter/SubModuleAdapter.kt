...
class SubModuleAdapter(private val context: Context?, private val subModuleList: List<SubModuleModel>) : RecyclerView.Adapter<SubModuleAdapter.ConnectionsHolder>() {
