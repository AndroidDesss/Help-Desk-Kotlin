...
//                dataMap["FileUpload"] = DataPart(fileName, fileContent)
            ...
            override fun getParams(): Map<String, String> {
                ...
                params["CompanyID"] = SharedPref.getCompanyId(this@CreateSubModule).toString()
                ...
                params["UserName"] = SharedPref.getUserName(this@CreateSubModule).toString()
                params["BoardID"] = uploadBoardId
                params["SprintID"] = uploadSprintId
                params["Billable"] = uploadBillable
                params["AllotedBy"] = SharedPref.getEmployeeId(this@CreateSubModule).toString()
    ...
    private fun filter(text: String) {
        val filteredlist: ArrayList<SubModuleModel> = ArrayList()
        for (item in subModuleList) {
        ...
        if (!filteredlist.isEmpty()) {
            subModuleAdapter!!.filterList(filteredlist)
        }
    }
