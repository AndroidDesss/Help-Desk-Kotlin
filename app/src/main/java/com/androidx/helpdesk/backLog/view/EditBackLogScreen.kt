...
import com.androidx.helpdesk.databinding.ActivityEditBackLogScreenBinding
import com.androidx.helpdesk.sharedStorage.SharedPref
import org.json.JSONException
import org.json.JSONObject
import java.io.File

class EditBackLogScreen : AppCompatActivity() {

    private var binding: ActivityEditBackLogScreenBinding? = null
...
//                dataMap["FileUpload"] = DataPart(fileName, fileContent)
            ...
            override fun getParams(): Map<String, String> {
                ...
                params["CompanyID"] = SharedPref.getCompanyId(this@EditBackLogScreen).toString()
                ...
                params["UserName"] = SharedPref.getUserName(this@EditBackLogScreen).toString()
                ...
                params["AllotedBy"] = SharedPref.getEmployeeId(this@EditBackLogScreen).toString()
