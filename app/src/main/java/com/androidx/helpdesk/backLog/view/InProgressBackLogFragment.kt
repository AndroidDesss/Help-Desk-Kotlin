...
import com.androidx.helpdesk.databinding.FragmentInProgressBackLogBinding
...
class InProgressBackLogFragment : Fragment() {

    private var firstVisit = false

    private var binding: FragmentInProgressBackLogBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_in_progress_back_log, container, false)
        firstVisit = true
        getInProgressBackLogList()
    ...
    private fun getInProgressBackLogList()
    {
        CommonMethod.showProgressDialog(context)
        binding!!.rlError.visibility = View.GONE
        backLogModelList.clear()
        stringRequest = StringRequest(
            Request.Method.GET, Api.inProgressBackLogList +  SharedPref.getCompanyId(context) ,
            { ServerResponse ->
    ...
    private fun inProgressBackLogDelete(id: Int?) {
        CommonMethod.showProgressDialog(context)
        stringRequest = StringRequest(
