...
import com.androidx.helpdesk.databinding.FragmentUnAssignedBackLogBinding
...
class UnAssignedBackLogFragment : Fragment() {

    private var firstVisit = false

    private var binding: FragmentUnAssignedBackLogBinding? = null
